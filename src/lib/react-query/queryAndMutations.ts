...
export const useUpdateUser = () => {
    ...
    return useMutation({
        ...
        onSuccess: (data) => {
            // belirli sorgu anahtarlarını geçersiz kılarak ilgili verileri önbellekten kaldırır ve verilerin yeniden alınmasını sağlar
...
export const useGetPosts = () => {
    return useInfiniteQuery({
        ...
        getNextPageParam: (lastPage: any) => {
            ...
            // İmlec olarak son belgenin $id'sini kullan
            const lastId = lastPage.documents[lastPage.documents.length - 1].$id;
            return lastId;
        },
        initialPageParam: 1, // sayfalama işleminin başlangıç parametresidir
    });
};
